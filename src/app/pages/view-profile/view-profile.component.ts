...
export class ViewProfileComponent implements OnInit {
  ...
  pageTitle =
    this.userRole == 'Consumer' ? 'Driver Profile' : 'Consumer Profile';
  ...
  constructor(
    ...
    this.activatedRoute.params.subscribe((data) => {
      data.driverId
        ...
        : (this.consumerId = data.poster_id);
  ...
  ngOnInit() {
    ...
    if (this.userRole == 'Consumer') {
      this.driverService
        .driverProfileById({ deliverer_id: this.driverId })
        .then((res: any) => {
      ...
      this.consumerApiService
        .getConsumerProfileByDriver({ consumer_id: this.consumerId })
        .then((res: any) => {
          this.driverProfileData = {
