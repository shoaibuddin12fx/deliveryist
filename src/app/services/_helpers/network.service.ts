...
export class NetworkService {
  ...
  isAuthorized() {
    return this.httpPostResponse(this.urls.user.authorize, {}, null, true, true);
  }
  ...
  postRegister(data) {
    return this.httpPostResponse(this.urls.user.register, data, null, true, true);
  }

  postForgetPassword(data){
    return this.httpPostResponse(this.urls.user.forgetpassword, data, null, true, true);
  }

  postDeviceToken(data){
    return this.httpPostResponse(this.urls.user.deviceToken, data, null, true, true);
  }
  ...
  postUpdateProduct(data) {
    return this.httpPostResponse(this.urls.product.update, data, null, true, true);
  }

  postGetProductChatRoom(data) {
    return this.httpPostResponse(this.urls.product.chatroom, data, null, true, true);
  }

  postSetProductFavorite(data){
    return this.httpPostResponse(this.urls.product.setFavorite, data, null, false, true);
  }

  postFileUpload(itemId, urls) {
    console.log(urls);
    return this.httpPostResponse(this.urls.product.uploadimages + itemId, urls, null, true, true, 'multipart/form-data');
  }

  postSingleFileUpload(file) {
    let req = {'file': file}
    return this.httpPostResponse(this.urls.product.uploadimage, req, null, true, true);
  }

  postGetRoomMessages(data) {
    return this.httpPostResponse(this.urls.chat.getMessages, data, null, true, true);
  }
  ...
  postGetMyItems() {
    return this.httpPostResponse(this.urls.product.myItems, {}, null, true, true);
  }

  postPlaceOrder(data) {
    console.warn(data);
    return this.httpPostResponse(this.urls.product.order, data, null, true, true);
  }

  postGetOrderDetailById(data) {
    console.warn(data);
    return this.httpPostResponse(this.urls.product.getOrderById, data, null, true, true);
  }

  

  postGetDeliveryCharges(data) {
    return this.httpPostResponse(this.urls.payment.payableAmount, data, null, true, true);
  }

  userRoleChange(data){
    return this.httpPostResponse(this.urls.user.roleChange, data, null, true, true);
  }

  sendMessage(messageObj){
    return this.httpPostResponse(this.urls.chat.messages, messageObj, null, false, false);
  }

  sendRoomMessasge(obj) {
    return this.httpPostResponse(this.urls.chat.roomMessages, obj, null, false, true);
  ...
  getProductById(id) {
    return this.httpGetResponse(this.urls.product.getOne + id, null, true, true);
  }

  getProductConditions() {
    return this.httpGetResponse(this.urls.product.getConditions, null, false, true);
  }

  getProductVehicleSize() {
    return this.httpGetResponse(this.urls.product.vehiclesizes, null, false, true);
  }
